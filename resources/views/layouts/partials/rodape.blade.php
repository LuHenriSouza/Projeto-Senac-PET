...
=======
                    <p class="mb-2"><i class="bi bi-geo-alt text-primary me-2"></i>Rua pet-ista nº13</p>
>>>>>>> Luiz
>>>>>>> a68d75f75d92edc105e68453730089d0423a9939
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-body mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Minha Conta</a>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">&copy; <a class="text-white" href="#">Patinha Feliz</a>. Todos os Direitos Reservados.</p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Desenvolvido por<a class="text-white" href="https://www.sp.senac.br/" target="_blank"> Senac</a></p>
                </div>
            </div>
        </div>
    </div>
