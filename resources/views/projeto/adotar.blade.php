...
@section('content')
    ...
    @if ($temCadastro)
        <!-- About Start -->
        <div class="container-fluid py-5" id="sobrenos">
            <div class="container">
                <div class="row gx-5">
                    ...
                    <div class="col-lg-7">
                        <div class="border-start border-5 border-primary ps-5 mb-5">
                            <h6 class="text-primary text-uppercase">Concluído</h6>
                            <h1 class="display-5 text-uppercase mb-0">Fique Atento no Email</h1>
                        </div>
                        <h4 class="text-body mb-4">
                            Agora é só aguardar, iremos analizar as informações enviadas e continuar o processo por Email, Seu PET ja é quase seu!
                        </h4>
                    </div>
                </div>
            </div>
